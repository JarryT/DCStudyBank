...
@property (nonatomic, strong) UILabel *centerTitleName;//副标题

@property (nonatomic, strong) UIColor *subTextColor; /**<Label的字体颜色 默认黑色*/
@property (nonatomic, strong) UIFont *subTextFont; /**<Label的字体大小 默认15*/
