...
@interface DCCollectionCategoryVC ()<DCHomeCellDelegate,UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *dataArray;
@property (nonatomic, strong) UITableView *tableView;
@end

@implementation DCCollectionCategoryVC
...
- (void)getKaoDianListDataWithName:(NSString *)name{
    weakSelf(self);
    [DCNetworkingRequest postString:CollectQueryPath params:@{@"cortype":name} withMappingObject:@"DCKaoDianModel" success:^(DCKaoDianModel *responseObject) {
