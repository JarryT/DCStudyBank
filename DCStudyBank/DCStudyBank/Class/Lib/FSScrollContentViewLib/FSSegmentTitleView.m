    ...
    [UIView animateWithDuration:(animated?0.05:0) animations:^{
        switch (_indicatorType) {
            ...
            case FSIndicatorTypeEqualTitle:
                self.indicatorView.center = CGPointMake(selectBtn.center.x, CGRectGetHeight(self.scrollView.bounds) - 8);
...
若设置选中第0个会出现bug，字体未选中
*/
- (void)setFirstStlectTitle:(NSInteger)index titleSelectFont:(UIFont *)titleSelectFont{
